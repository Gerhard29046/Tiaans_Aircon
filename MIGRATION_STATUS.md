...
- Configure production Cloudflare Access for `/admin*` and `/api/admin*`, plus the exact team domain and application AUD. Preview Access alone does not protect production.
